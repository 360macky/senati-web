          ...
          <section>
            <div class="container">
              <div class="contactinfo">
                <div>
                  <h2>Contacto Senati</h2>
                  <ul class="info">
                    <li>
                      <span
                        ><img src="img/marcador-de-posicion.png" alt=""
                      /></span>
                      <span> Av. 28 de Julio 715, Cercado de Lima 15046 </span>
                    </li>
                    <li>
                      <span><img src="img/phone-call.png" alt="" /></span>
                      <span>(01) 6223434 </span>
                    </li>
                    <li>
                      <span><img src="img/mailbox.png" alt="" /></span>
                      <span> soportevirtual@senati.pe. </span>
                    </li>
                  </ul>
                  <ul class="sci">
                    <li>
                      <a href="https://www.facebook.com/SenatiOficial/"
                    ...
                    <li>
                      <a href=""><img src="img/youtube (2).png" alt="" /></a>
                    </li>
                  </ul>
                </div>
              </div>
...
section .container .contactinfo {
    ...
    box-shadow: 0 20px 20 px rgb(0, 0, 0, 0.2);
}
...
section .container .contactForm {
    ...
    height: 100%;
    box-shadow: 0 25px 25px rgb(0, 0, 0, 0.5);
}
