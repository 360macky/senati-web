    ...
    <div>
        ...
        <div id="sidebar-container" class="bg-primary">
            ...
            <div class="menu">
                ...
                <a href="documentacionalumno" class="selected d-block text-light p-3"><i class="far fa-file mr-2"></i>Documentación</a>
                    ...
                    <div class="container py-3">
                        <div>
                            ...
                            <div class="alert alert-danger" style="
                             border-color: #f5c6cb; position: relative;padding: 0.75rem 1.25rem; margin-bottom: 1rem;    border: 1px solid transparent;border-radius: 0.25rem; flex-wrap: wrap;-ms-flex-wrap: wrap;" id="alert">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form>
                                    ...
                                    <div class="card mt-3" id="file_1_container">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <input type="file" class="form-control-file" id="file_1" @change="updateBorderColor_DNI()">
                                                        ...
                                                        <button type="submit" class="btn btn-info btn-lg mt-3" @click.prevent="send()">Enviar</button>
                                                    </div>
                                    ...
                                    <div class="card mt-3" id="file_2_container">
                                        <div class="card-header">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <input type="file" class="form-control-file" id="file_2" @change="updateBorderColor_Estudios()">
                                    ...
                                    <div class="card mt-3" id="file_3_container">
                                        <div class="card-header">
                                            <h4>Proyecto</h4>
                                        </div>
                                        <div class="card-body">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <input type="file" class="form-control-file" id="file_3" @change="updateBorderColor_Proyecto()">
...
export default {
    ...
    methods: {
        ...
        updateBorderColor_DNI() {
            ...
            document.querySelector('#file_1_container').classList.add('border-success');
        },
        updateBorderColor_Estudios() {
            document.querySelector('#file_2_container').classList.add('border');
            document.querySelector('#file_2_container').classList.add('border-success');
        },
        updateBorderColor_Proyecto() {
            document.querySelector('#file_3_container').classList.add('border');
            document.querySelector('#file_3_container').classList.add('border-success');
        },
    }
}
</script>
